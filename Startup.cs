...
namespace DemoApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
          ...
          //  services.AddScoped<IGenericRepository<Identity>, GenericRepository<Identity>>();
            ...
            services.AddCors(option => option.AddPolicy("KPMGPolicy", builder => {
